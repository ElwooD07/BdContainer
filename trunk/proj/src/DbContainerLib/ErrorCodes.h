...
namespace dbc
{
	enum ErrCommon
	{
		...
		LINK_IS_EMPTY = 0x8600,
		LINK_IS_NOT_REFERENCEABLE = 0x8700,
		ERR_INTERNAL = 0xfefe,
	...
	enum ErrExtended
	{
		...
		ERR_DATA_CANT_OPEN_SRC = 0x0580, // src
		ERR_DATA_CANT_OPEN_DEST = 0x0581, // dest
		ERR_DATA_SHORT_SRC = 0x0582, // src
		ERR_DATA_CANT_ALLOCATE_SPACE = 0x0583, // dest
